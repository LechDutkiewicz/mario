// World 4-2 — converted from FSM World42 (entrance → big underworld with a
// vine bonus and a side-pipe bonus → overworld exit). Warp zones to worlds
// 5-8 skipped (those worlds don't exist here yet).
export const world42Data = {
  "name": "4-2",
  "locations": [
    { "entry": "Walking" },
    { "area": 1 },
  ...
  "areas": [
    ...
    },
    {
      ...
      "creation": [
        ...
        { "macro": "Floor", "x": 136, "width": 8 },

        { "macro": "Fill", "thing": "Brick", "x": 160, "y": 64, "xnum": 23, "ynum": 3, "xwidth": 8, "yheight": 8 },
        { "macro": "Floor", "x": 168, "width": 288 },
        { "macro": "Fill", "thing": "Brick", "x": 176, "y": 16, "xnum": 5, "ynum": 3, "xwidth": 8, "yheight": 8 },
        { "thing": "Brick", "x": 216, "y": 32 },
        { "macro": "Fill", "thing": "Coin", "x": 217, "y": 7, "xnum": 3, "xwidth": 8 },
        { "thing": "Brick", "x": 224, "y": 32, "contents": "Mushroom" },
        { "macro": "Fill", "thing": "Brick", "x": 240, "y": 8, "xnum": 18, "ynum": 4, "xwidth": 8, "yheight": 8 },
        ...
        { "macro": "Fill", "thing": "Brick", "x": 352, "y": 64, "xnum": 4, "ynum": 3, "xwidth": 8, "yheight": 8 },
        { "macro": "Fill", "thing": "Block", "x": 400, "y": 32, "xnum": 2, "ynum": 2, "xwidth": 8, "yheight": 32 },
        { "macro": "Fill", "thing": "Block", "x": 432, "y": 32, "xnum": 2, "xwidth": 16 },
        { "thing": "Block", "x": 440, "y": 32, "contents": "Mushroom" },

        { "macro": "PlatformGenerator", "x": 470, "width": 6, "direction": 1 },

        { "macro": "Floor", "x": 504, "width": 336 },
        { "thing": "Block", "x": 504, "y": 40, "contents": "Coin", "hidden": true },
        { "thing": "Block", "x": 512, "y": 48, "contents": "Coin", "hidden": true },
        { "thing": "Brick", "x": 512, "y": 64, "contents": ["Vine", { "transport": 5 }] },
        { "thing": "Block", "x": 520, "y": 40, "contents": "Coin", "hidden": true },
        { "macro": "Fill", "thing": "Brick", "x": 520, "y": 64, "xnum": 2, "xwidth": 8 },
        { "thing": "Block", "x": 528, "y": 32, "contents": "Coin", "hidden": true },
        ...
        { "macro": "Pipe", "x": 856, "height": 32, "piranha": true },

        { "macro": "Floor", "x": 888, "width": 16 },
        { "thing": "Stone", "x": 888, "y": 24, "width": 16, "height": 24 },

        { "macro": "PlatformGenerator", "x": 918, "width": 6, "direction": 1 },
        { "macro": "Floor", "x": 952, "width": 32 },
        { "macro": "Fill", "thing": "Brick", "x": 952, "y": 32, "xnum": 4, "xwidth": 8 },
        { "thing": "Brick", "x": 952, "y": 64 },
        { "macro": "Fill", "thing": "Brick", "x": 952, "y": 88, "xnum": 4, "xwidth": 8 },
        { "thing": "Brick", "x": 960, "y": 64, "contents": "Mushroom" },
        { "thing": "Brick", "x": 968, "y": 64 },

        { "macro": "PlatformGenerator", "x": 992, "width": 6, "direction": -1 },
        ...
        { "thing": "BuzzyBeetle", "x": 1232, "y": 32.5 },

        { "macro": "PlatformGenerator", "x": 1246, "width": 6, "direction": 1 },

        { "macro": "Floor", "x": 1280, "width": 184 },
        { "macro": "Fill", "thing": "Brick", "x": 1280, "y": 48, "ynum": 2, "yheight": 8 },
        { "macro": "Fill", "thing": "Brick", "x": 1280, "y": 64, "xnum": 16, "ynum": 3, "xwidth": 8, "yheight": 8 },
        { "macro": "Ceiling", "x": 1280, "width": 232 },
        { "thing": "Brick", "x": 1288, "y": 32, "contents": "Mushroom" },
        { "macro": "Fill", "thing": "Brick", "x": 1296, "y": 32, "xnum": 10, "xwidth": 8 },
        ...
        { "thing": "BuzzyBeetle", "x": 1432, "y": 8.5 },
        { "macro": "Pipe", "x": 1440, "height": 56, "piranha": true },

        { "macro": "Floor", "x": 1480, "width": 312 },
        { "macro": "Fill", "thing": "Brick", "x": 1480, "y": 8, "xnum": 24, "ynum": 3, "xwidth": 8, "yheight": 8 },
        { "thing": "PipeHorizontal", "x": 1496, "y": 40, "transport": 4 },
        { "thing": "PipeVertical", "x": 1512, "y": 88, "height": 64 },
        { "macro": "Fill", "thing": "Brick", "x": 1528, "y": 32, "xnum": 18, "ynum": 7, "xwidth": 8, "yheight": 8 },
        { "macro": "Ceiling", "x": 1528, "width": 224 }
      ]
    },
    {
      "setting": "Underworld",
    ...
    },
    {
      ...
      "blockBoundaries": true,
      "creation": [
        { "macro": "Pattern", "pattern": "BackRegular", "x": 104, "repeat": 1 },
        { "macro": "Floor", "width": 464 },
        { "macro": "Pipe", "x": 0, "height": 16, "piranha": true, "entrance": 4 },
        ...
        { "macro": "EndOutsideCastle", "x": 148, "transport": { "map": "4-3" } }
      ]
    },
    {
      "setting": "Overworld",
      ...
      "creation": [
        ...
        { "thing": "Stone", "x": 392, "y": 72, "width": 88, "height": 72 }
      ]
    }
  ]
};
