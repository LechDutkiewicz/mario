// World 7-2 — converted from FSM World72 (entrance → the longest underwater
// stretch in the game → overworld exit)
export const world72Data = {
  "name": "7-2",
  "locations": [{ "entry": "Walking" }, { "area": 1 }, { "area": 2, "entry": "PipeVertical" }],
  "areas": [
    {
      "setting": "Overworld",
    ...
    },
    {
      ...
      "creation": [
        ...
        { "thing": "Stone", "x": 152, "y": 32, "width": 24, "height": 8 },
        ...
        { "thing": "Stone", "x": 344, "y": 32, "width": 16, "height": 8 },
        ...
        { "thing": "Stone", "x": 664, "y": 64, "width": 24, "height": 8 },
        ...
        { "thing": "Stone", "x": 1064, "y": 72, "width": 64, "height": 8 },
        ...
        { "thing": "Stone", "x": 1264, "y": 64, "width": 16, "height": 8 },
        { "thing": "Stone", "x": 1304, "y": 64, "width": 16, "height": 8 },
        ...
        { "macro": "Fill", "thing": "Stone", "x": 1384, "y": 32, "ynum": 2, "yheight": 32, "width": 40, "height": 8 },
        { "thing": "Blooper", "x": 1392, "y": 14 },
        { "thing": "Coral", "x": 1392, "y": 80, "height": 16 },
        { "thing": "CheepCheep", "x": 1408, "y": 40 },
        { "thing": "Blooper", "x": 1440, "y": 14 },
        { "macro": "Fill", "thing": "Stone", "x": 1448, "y": 32, "ynum": 2, "yheight": 32, "width": 32, "height": 8 },
        ...
        { "thing": "PipeHorizontal", "x": 1520, "y": 48, "transport": 2 },
    ...
    },
    {
      ...
      "creation": [
        ...
        { "macro": "Pipe", "x": 0, "height": 16, "piranha": true, "entrance": 2 },
        ...
        { "macro": "EndOutsideCastle", "x": 148, "transport": { "map": "7-3" } }
      ]
    }
  ]
};
