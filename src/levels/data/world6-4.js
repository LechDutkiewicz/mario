// World 6-4 — converted from FSM World64 (castle: long fire-bar corridor,
// lava pits, hidden coin blocks; hard boss that also throws bones)
export const world64Data = {
  "name": "6-4",
  "time": 300,
  ...
  "areas": [
    {
      ...
      "creation": [
        ...
        { "thing": "Stone", "x": 40, "y": 88, "width": 152, "height": 24 },
        { "macro": "Floor", "x": 40, "y": 24, "width": 64 },
        { "macro": "Water", "x": 104, "y": 8, "width": 32 },

        { "macro": "Floor", "x": 120, "y": 24, "width": 88 },
        { "thing": "Stone", "x": 184, "y": 64, "width": 8, "height": 8 },
        { "thing": "CastleBlock", "x": 184, "y": 56, "fireballs": 6 },
        { "thing": "Stone", "x": 192, "y": 88, "width": 1088, "height": 8 },
        { "macro": "Water", "x": 208, "width": 48 },
        ...
        { "macro": "Water", "x": 256, "width": 48 },
        { "thing": "Podoboo", "x": 264, "y": -32 },

        { "thing": "Stone", "x": 280, "y": 32, "width": 296, "height": 8 },
        ...
        { "thing": "Block", "x": 848, "y": 32, "contents": "Coin", "hidden": true },
        { "thing": "Block", "x": 872, "y": 32, "contents": "Coin", "hidden": true },
        { "thing": "Block", "x": 896, "y": 32, "contents": "Coin", "hidden": true },
        { "thing": "Block", "x": 856, "y": 64, "contents": "Coin", "hidden": true },
        { "thing": "Block", "x": 880, "y": 64, "contents": "Coin", "hidden": true },
        { "thing": "Block", "x": 904, "y": 64, "contents": "Coin", "hidden": true },
        ...
        { "macro": "EndInsideCastle", "x": 1024, "hard": true }
      ]
    }
  ]
};
