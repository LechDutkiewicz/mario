// World 6-2 — converted from FSM World62 (night pipe maze with FOUR bonus
// areas: two underworlds, an underwater section and a sky bonus)
export const world62Data = {
  "name": "6-2",
  "locations": [
    { "entry": "Plain" }, { "entry": "PipeVertical" }, { "entry": "PipeVertical" },
    { "xloc": 1304 }, { "entry": "PipeVertical" },
    { "area": 1 }, { "area": 2 }, { "area": 3, "entry": "Vine" }, { "area": 4 }
  ],
  "areas": [
    {
      "setting": "Night",
      ...
      "creation": [
        ...
        { "macro": "Fill", "thing": "Brick", "x": 80, "y": 32, "xnum": 3, "xwidth": 8 },
        { "macro": "Pipe", "x": 152, "height": 32, "piranha": true, "transport": 5 },
        { "thing": "Brick", "x": 184, "y": 64 },
        { "thing": "Block", "x": 192, "y": 32, "contents": "Coin", "hidden": true },
        ...
        { "macro": "Fill", "thing": "Brick", "x": 536, "y": 64, "xnum": 5, "xwidth": 8 },
        { "thing": "Goomba", "x": 536, "y": 72 },
        { "macro": "Pipe", "x": 592, "height": 16, "piranha": true },
        { "macro": "Fill", "thing": "Brick", "x": 616, "y": 64, "xnum": 4, "xwidth": 8 },
        { "macro": "Pipe", "x": 640, "height": 24, "piranha": true },
        { "thing": "Brick", "x": 648, "y": 64, "contents": ["Vine", { "transport": 7 }] },
        { "thing": "Block", "x": 656, "y": 32, "contents": "Coin", "hidden": true },
        { "macro": "Pipe", "x": 672, "height": 16, "piranha": true },
        { "macro": "Pipe", "x": 696, "height": 48, "piranha": true },
        { "thing": "BuzzyBeetle", "x": 736, "y": 8.5 },
        ...
        { "macro": "Fill", "thing": "Brick", "x": 952, "y": 64, "xnum": 9, "xwidth": 8 },
        { "thing": "BuzzyBeetle", "x": 960, "y": 72.5 },

        { "macro": "Floor", "x": 1032, "width": 96 },
        { "macro": "Pipe", "x": 1048, "height": 16, "piranha": true },
        { "macro": "Pipe", "x": 1080, "height": 16, "piranha": true },
        { "macro": "Fill", "thing": "Brick", "x": 1104, "y": 40, "xnum": 2, "xwidth": 8 },
        { "thing": "Brick", "x": 1120, "y": 64, "contents": "Star" },
        { "thing": "Brick", "x": 1128, "y": 64 },
        { "macro": "Floor", "x": 1136, "width": 8 },

        { "macro": "Floor", "x": 1152, "width": 64 },
        { "macro": "Fill", "thing": "Brick", "x": 1152, "y": 32, "xnum": 3, "xwidth": 8 },
        { "macro": "Fill", "thing": "Brick", "x": 1160, "y": 64, "xnum": 2, "xwidth": 8 },
        ...
        { "macro": "Fill", "thing": "Brick", "x": 1280, "y": 32, "xnum": 3, "ynum": 2, "xwidth": 8, "yheight": 32 },
        { "thing": "BuzzyBeetle", "x": 1304, "y": 8.5 },
        ...
        { "macro": "EndOutsideCastle", "x": 1724, "transport": { "map": "6-3" } }
      ]
    },
    {
      "setting": "Underworld",
    ...
    },
    {
      ...
      "creation": [
        ...
        { "thing": "PipeHorizontal", "x": 496, "y": 48, "transport": 2 },
