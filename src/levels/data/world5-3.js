// World 5-3 — converted from FSM World53 (tree-top level with lifts)
export const world53Data = {
  "name": "5-3",
  ...
  "areas": [
    {
      ...
      "creation": [
        { "macro": "CastleSmall" },
        { "macro": "Pattern", "pattern": "BackCloud", "y": 4, "repeat": 8 },
        ...
        { "thing": "Platform", "x": 752, "y": 32, "width": 24, "sliding": true, "begin": 700, "end": 776 },
