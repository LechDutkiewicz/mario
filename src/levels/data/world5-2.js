// World 5-2 — converted from FSM World52 (cannons + Cubones, underwater
// bonus, vine to a sky bonus). Warp zones omitted.
export const world52Data = {
  "name": "5-2",
  "locations": [
    { "entry": "Plain" }, { "entry": "PipeVertical" },
    { "xloc": 1032 }, { "area": 1 }, { "area": 2, "entry": "Vine" }
  ],
  "areas": [
    {
      "setting": "Overworld",
      ...
      "creation": [
        ...
        { "thing": "Stone", "x": 120, "y": 24, "height": 24 },
        { "thing": "Stone", "x": 120, "y": 32, "width": 32 },
        { "thing": "Cannon", "x": 136, "y": 48, "height": 2 },
        ...
        { "macro": "Fill", "thing": "Brick", "x": 232, "y": 32, "xnum": 6, "xwidth": 8 },
        { "macro": "Fill", "thing": "Brick", "x": 232, "y": 64, "xnum": 5, "xwidth": 8 },
        ...
        { "macro": "Fill", "thing": "Block", "x": 624, "y": 32, "xnum": 5, "xwidth": 8 },
        { "thing": "HammerBro", "x": 648, "y": 46 },
        { "thing": "Block", "x": 672, "y": 32, "contents": "Coin", "hidden": true },
        { "thing": "Brick", "x": 680, "y": 64, "contents": ["Vine", { "transport": 4 }] },
        { "macro": "Fill", "thing": "Brick", "x": 688, "y": 64, "xnum": 2, "xwidth": 8 },
        { "macro": "Fill", "thing": "Coin", "x": 689, "y": 71, "xnum": 2, "xwidth": 8 },
        { "macro": "Fill", "thing": "Brick", "x": 712, "y": 40, "xnum": 3, "xwidth": 8 },
        { "macro": "Fill", "thing": "Coin", "x": 713, "y": 7, "xnum": 2, "xwidth": 8 },

        { "macro": "Floor", "x": 768, "width": 248 },
        { "thing": "Koopa", "x": 848, "y": 32, "jumping": true },
        { "thing": "Cannon", "x": 856, "y": 16, "height": 2 },
        { "macro": "Pipe", "x": 920, "height": 16, "piranha": true, "entrance": 1 },
        { "macro": "Fill", "thing": "Brick", "x": 944, "y": 32, "xnum": 8, "xwidth": 8 },
        { "macro": "Fill", "thing": "Brick", "x": 944, "y": 64, "xnum": 7, "xwidth": 8 },
        ...
        { "macro": "Fill", "thing": "BuzzyBeetle", "x": 1088, "y": 8.5, "xnum": 3, "xwidth": 8.5 },
        { "thing": "Brick", "x": 1128, "y": 16, "contents": "Coin" },
        { "thing": "Brick", "x": 1136, "y": 16, "contents": "Mushroom" },

        { "macro": "Fill", "thing": "Brick", "x": 1176, "y": 32, "xnum": 3, "xwidth": 8 },
        { "macro": "Floor", "x": 1208, "width": 152 },
        { "macro": "Fill", "thing": "Brick", "x": 1224, "y": 64, "xnum": 5, "xwidth": 8 },
        ...
        { "macro": "Fill", "thing": "Brick", "x": 1376, "y": 64, "xnum": 4, "xwidth": 8 },
        ...
        { "macro": "EndOutsideCastle", "x": 1596, "transport": { "map": "5-3" } }
      ]
    },
    {
      "setting": "Underwater",
    ...
    },
    {
      ...
      "creation": [
        ...
        { "thing": "Platform", "x": 120, "y": 32, "width": 24, "transport": true },
        { "macro": "Fill", "thing": "Stone", "x": 120, "y": 64, "xnum": 16, "xwidth": 8 },
        { "macro": "Fill", "thing": "Stone", "x": 256, "y": 80, "xnum": 3, "xwidth": 8 },
        { "macro": "Fill", "thing": "Stone", "x": 288, "y": 72, "xnum": 16, "xwidth": 8 },
        { "macro": "Fill", "thing": "Stone", "x": 424, "y": 80, "xnum": 3, "xwidth": 8 }
      ]
    }
  ]
};
